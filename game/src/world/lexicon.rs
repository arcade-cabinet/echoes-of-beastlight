    ...
    fn default() -> Self {
        ...
        lexicon.nouns.categories.insert(
            ...
            vec![
                Word {
                    text: "Wolf",
                    tags: vec!["beast", "predator"],
                    weight: 1.0,
                    corruption_modifier: 0.0,
                },
                Word {
                    text: "Bear",
                    tags: vec!["beast", "strong"],
                    weight: 1.0,
                    corruption_modifier: 0.0,
                },
                Word {
                ...
                Word {
                    text: "Wisp",
                    tags: vec!["spirit", "light"],
                    weight: 1.0,
                    corruption_modifier: -0.1,
                },
                Word {
                    text: "Shade",
                    tags: vec!["spirit", "dark"],
                    weight: 1.0,
                    corruption_modifier: 0.2,
                },
            ],
        ...
        lexicon.nouns.categories.insert(
            ...
            vec![
                ...
                Word {
                    text: "Temple",
                    tags: vec!["structure", "holy"],
                    weight: 0.8,
                    corruption_modifier: -0.3,
                },
                Word {
                    text: "Ruins",
                    tags: vec!["structure", "old"],
                    weight: 0.9,
                    corruption_modifier: 0.3,
                },
            ],
        ...
        lexicon.nouns.categories.insert(
            ...
            vec![
                Word {
                    text: "Blade",
                    tags: vec!["weapon", "slash"],
                    weight: 1.0,
                    corruption_modifier: 0.0,
                },
                Word {
                    text: "Staff",
                    tags: vec!["weapon", "magic"],
                    weight: 1.0,
                    corruption_modifier: -0.1,
                },
                Word {
                    text: "Orb",
                    tags: vec!["magic", "round"],
                    weight: 0.9,
                    corruption_modifier: 0.0,
                },
                Word {
                ...
                Word {
                    text: "Amulet",
                    tags: vec!["accessory", "magic"],
                    weight: 0.9,
                    corruption_modifier: -0.1,
                },
                Word {
                    text: "Tome",
                    tags: vec!["magic", "knowledge"],
                    weight: 0.8,
                    corruption_modifier: 0.0,
                },
            ],
