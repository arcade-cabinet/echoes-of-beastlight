			...
			<View style={styles.settingsContainer}>
				<View style={styles.settingItem}>
					...
					<View style={styles.sliderContainer}>
						<Slider
							...
							onSlidingComplete={(value) => updateSettings({ musicVolume: value })}
				...
				<View style={styles.settingItem}>
					...
					<View style={styles.sliderContainer}>
						<Slider
							...
							onSlidingComplete={(value) => updateSettings({ sfxVolume: value })}
							minimumTrackTintColor="#7c3aed"
							maximumTrackTintColor="#3d3d5c"
							thumbTintColor="#7c3aed"
							accessibilityLabel="SFX volume slider"
						/>
				...
				<View style={styles.settingItem}>
					...
					<Pressable
						...
						accessibilityState={{ checked: settings.battleAnimations }}
					>
